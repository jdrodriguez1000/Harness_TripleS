...
- **Actualización (D-036, 2026-07-23):** Resuelta para el producto. Se decidió que el bucle interior se construye con el Claude Agent SDK for Python usando `tool_use` estructurado, no con esta convención de marcador. Esta restricción queda documentada como el diseño previo explorado en T-018 (Camino A), no como el camino de producto (Camino B); T-020 valida el Camino B con un spike equivalente.
